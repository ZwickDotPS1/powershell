...
# This function tests that the value for $ENV:MOFUMOBIDB is correct by creating a connection object, 
...
testSqlCredentials -Server $SQLServer -Database $MofuMobiDB -Username $SQLUser -Password $SQLPassword