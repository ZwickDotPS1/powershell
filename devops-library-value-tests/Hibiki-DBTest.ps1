...
# This function tests that the value for $ENV:HIBIKIDB is correct by creating a connection object, 
...
testSqlCredentials -Server $SQLServer -Database $HibikiDB -Username $SQLUser -Password $SQLPassword